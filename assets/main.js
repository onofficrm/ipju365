...
const MANAGERS = [
  { id: 1, name: "ì§€ì•„", age: 22, image: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=500", status: "available" },
  { id: 2, name: "ìˆ˜ì§„", age: 24, image: "https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&q=80&w=500", status: "busy" },
  { id: 3, name: "ë¯¼ì§€", age: 23, image: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&q=80&w=500", status: "available" },
  { id: 4, name: "ìœ ë‚˜", age: 21, image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=500", status: "available" }
];
const Header = () => {
  const [isOpen, setIsOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed w-full z-50 bg-dark-900/70 backdrop-blur-xl border-b border-white/5 transition-all duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 h-20 flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-bold tracking-tight text-white", children: [
        "SIWON ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-gold", children: "TOUR" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex space-x-10", children: ["ì¶œìž¥ë§ˆì‚¬ì§€", "ì—ì½”ê±¸", "í’€ë¹Œë¼", "íˆ¬ì–´"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${item}`, className: "text-sm font-medium text-gray-300 hover:text-gold-400 transition-colors tracking-wide uppercase", children: item }, item)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center space-x-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-sm font-medium text-gray-400 hover:text-white transition-colors", children: "ë¡œê·¸ì¸" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-gradient-gold text-white px-6 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-gold-500/20 hover:shadow-gold-500/40 hover:scale-105 transition-all duration-300", children: "ìƒë‹´í•˜ê¸°" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "md:hidden text-white", onClick: () => setIsOpen(!isOpen), children: isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-6 h-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "w-6 h-6" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col p-6 space-y-4", children: ["ì¶œìž¥ë§ˆì‚¬ì§€", "ì—ì½”ê±¸", "í’€ë¹Œë¼", "íˆ¬ì–´"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `#${item}`, className: "text-lg font-medium text-gray-300 hover:text-gold-400", onClick: () => setIsOpen(false), children: item }, item)) })
      }
    ) })
  ] });
};
const HeroSlider = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[800px] flex items-center justify-center overflow-hidden", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-dark-900/30 via-dark-900/50 to-dark-900" })
  ] }),
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 max-w-4xl mx-auto mt-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.span,
      {
        ...
        className: "inline-block py-1 px-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-gold-400 text-xs font-bold tracking-widest uppercase mb-6",
        children: "Premium Cebu Travel Service"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.h1,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-gold", children: "íŠ¹ë³„í•œ ë°¤" }),
          "ì„ ë””ìžì¸í•˜ë‹¤"
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.p,
      {
        ...
        children: [
          "í”„ë¦¬ë¯¸ì—„ ì¶œìž¥ ë§ˆì‚¬ì§€ë¶€í„° ì—ì½”ê±¸, í’€ë¹Œë¼ê¹Œì§€.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "hidden md:block" }),
          "ë‹¹ì‹ ì˜ ì™„ë²½í•œ ì—¬í–‰ì„ ìœ„í•œ ëª¨ë“  ê²ƒì´ ì¤€ë¹„ë˜ì–´ ìžˆìŠµë‹ˆë‹¤."
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "w-full sm:w-auto bg-gradient-gold text-white px-10 py-4 rounded-full text-lg font-bold shadow-xl shadow-gold-500/30 hover:shadow-gold-500/50 hover:-translate-y-1 transition-all duration-300", children: "ì§€ê¸ˆ ì˜ˆì•½ ìƒë‹´í•˜ê¸°" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "w-full sm:w-auto bg-white/10 backdrop-blur-md border border-white/20 text-white px-10 py-4 rounded-full text-lg font-medium hover:bg-white/20 transition-all duration-300", children: "ì„œë¹„ìŠ¤ ë‘˜ëŸ¬ë³´ê¸°" })
        ]
      }
    )
  ] })
] });
const SectionTitle = ({ title, subtitle }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-white mb-3 tracking-tight", children: title }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold-500 font-medium tracking-wide uppercase text-sm mb-6", children: subtitle }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-1 bg-gradient-gold mx-auto rounded-full" })
] });
const ManagerCard = ({ manager }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "group relative bg-dark-800 rounded-2xl overflow-hidden border border-white/5 hover:border-gold-500/50 transition-all duration-500 shadow-lg hover:shadow-gold-500/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[3/4] overflow-hidden", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      src: manager.image,
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-dark-900/90 via-transparent to-transparent" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute top-3 right-3 px-3 py-1 rounded-full text-[10px] font-bold tracking-wider uppercase border ${manager.status === "available" ? "bg-green-500/20 border-green-500/50 text-green-400" : "bg-red-500/20 border-red-500/50 text-red-400"}`, children: manager.status === "available" ? "Available" : "Booked" }),
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 w-full p-6 translate-y-2 group-hover:translate-y-0 transition-transform duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-white mb-1 tracking-tight", children: manager.name }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gold-400 text-sm font-medium", children: [
      manager.age,
      "ì„¸ / í•œêµ­ì–´ ê°€ëŠ¥"
    ] })
  ] })
] }) });
const BoardList = ({ title, boardId, posts }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-dark-800/50 backdrop-blur-sm rounded-3xl p-8 border border-white/5 hover:border-white/10 transition-colors h-full", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-end mb-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-white mb-1 tracking-tight", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-1 bg-gold-500 rounded-full" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: `/bbs/board.php?bo_table=${boardId}`, className: "text-xs font-bold text-gray-500 hover:text-white uppercase tracking-wider transition-colors", children: "View All +" })
  ] }),
  posts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center items-center h-48 text-gray-500 text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 border-2 border-gold-500/30 border-t-gold-500 rounded-full animate-spin mb-3" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-pulse", children: "Loading posts..." })
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0", children: posts.map((post, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "group flex items-center justify-between py-4 border-b border-white/5 last:border-0 hover:bg-white/[0.02] transition-colors px-2 -mx-2 rounded-lg cursor-pointer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-gold-500/50", children: [
        "0",
        index + 1
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300 group-hover:text-gold-400 text-sm font-medium truncate transition-colors", children: post.title })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-600 whitespace-nowrap ml-4 font-mono", children: post.date })
  ] }, post.id)) })
] });
const FloatingButtons = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-8 right-8 z-50 flex flex-col space-y-4", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.button,
    {
      ...
      whileTap: { scale: 0.9 },
      onClick: () => {
        alert("ì¹´ì¹´ì˜¤í†¡ ID: siwon9");
      },
      className: "w-14 h-14 bg-[#FEE500] rounded-full flex items-center justify-center shadow-lg shadow-[#FEE500]/30 border-2 border-white/10",
      title: "ì¹´ì¹´ì˜¤í†¡ ìƒë‹´",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-7 h-7 text-[#3c1e1e] fill-current" })
    }
  ),
  /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.button,
    {
      whileHover: { scale: 1.1 },
      whileTap: { scale: 0.9 },
      onClick: () => window.open("https://t.me/siwoncare", "_blank"),
      className: "w-14 h-14 bg-[#229ED9] rounded-full flex items-center justify-center shadow-lg shadow-[#229ED9]/30 border-2 border-white/10",
      title: "í…”ë ˆê·¸ëž¨ ìƒë‹´",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "w-6 h-6 text-white ml-0.5" })
    }
  ),
  /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.button,
    {
      whileHover: { scale: 1.1 },
      whileTap: { scale: 0.9 },
      onClick: () => window.open("https://line.me/ti/p/~siwoncare", "_blank"),
      className: "w-14 h-14 bg-[#06C755] rounded-full flex items-center justify-center shadow-lg shadow-[#06C755]/30 border-2 border-white/10",
      title: "ë¼ì¸ ìƒë‹´",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-7 h-7 text-white" })
    }
  )
] });
const fetchLatestPosts = async (boardId) => {
  await new Promise((resolve) => setTimeout(resolve, 500));
  if (boardId === "notice") {
    return [
      { id: 1, title: "[ê³µì§€] 2024ë…„ ì‹œì¦Œ ê°€ê²© ì¸í•˜ ì•ˆë‚´", date: "2024-05-20", author: "ê´€ë¦¬ìž" },
      { id: 2, title: "ì„¸ë¶€ ë§‰íƒ„ ì§€ì—­ ì¶œìž¥ë¹„ ë¬´ë£Œ ì´ë²¤íŠ¸", date: "2024-05-18", author: "ê´€ë¦¬ìž" },
      { id: 3, title: "ì‹ ê·œ ë§¤ë‹ˆì € ì˜ìž… ì™„ë£Œ (í”„ë¡œí•„ í™•ì¸)", date: "2024-05-15", author: "ê´€ë¦¬ìž" },
      { id: 4, title: "ì˜ˆì•½ê¸ˆ ìž…ê¸ˆ ê³„ì¢Œ ë³€ê²½ ì•ˆë‚´", date: "2024-05-10", author: "ê´€ë¦¬ìž" },
      { id: 5, title: "ì‚¬ì´íŠ¸ ë¦¬ë‰´ì–¼ ì˜¤í”ˆ ê¸°ë… ì¿ í° ì§€ê¸‰", date: "2024-05-01", author: "ê´€ë¦¬ìž" }
    ];
  }
  if (boardId === "free") {
    return [
      { id: 1, title: "ë§ˆì‚¬ì§€ ì •ë§ ì‹œì›í•˜ë„¤ìš”! ìž¬ë°©ë¬¸ ì˜ì‚¬ 100%", date: "2024-05-21", author: "ê¹€**" },
      { id: 2, title: "ì—ì½”ê±¸ ì§€ì•„ë‹˜ ë•ë¶„ì— ì¦ê±°ìš´ ì—¬í–‰ì´ì—ˆìŠµë‹ˆë‹¤", date: "2024-05-20", author: "ì´**" },
      { id: 3, title: "í’€ë¹Œë¼ ì‹œì„¤ì´ ì‚¬ì§„ë³´ë‹¤ í›¨ì”¬ ì¢‹ë„¤ìš”", date: "2024-05-19", author: "ë°•**" },
      { id: 4, title: "ê³¨í”„ íˆ¬ì–´ íŒ¨í‚¤ì§€ ê°€ì„±ë¹„ ìµœê³ ìž…ë‹ˆë‹¤", date: "2024-05-18", author: "ìµœ**" },
      { id: 5, title: "ì²« ì„¸ë¶€ ì—¬í–‰ì¸ë° ë„ˆë¬´ ì¹œì ˆí•˜ê²Œ ì•ˆë‚´í•´ì£¼ì…¨ì–´ìš”", date: "2024-05-17", author: "ì •**" }
    ];
  }
  return [];
};
function App() {
  ...
  React.useEffect(() => {
    const loadPosts = async () => {
      const noticeData = await fetchLatestPosts("notice");
      setNotices(noticeData);
      const reviewData = await fetchLatestPosts("free");
      setReviews(reviewData);
    };
    loadPosts();
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-dark-900 font-sans text-gray-100 selection:bg-gold-500 selection:text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSlider, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "ì¶œìž¥ë§ˆì‚¬ì§€", className: "py-20 px-4 max-w-7xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: "CEBU NO.1 MASSAGE", subtitle: "ì§€ì¹œ ëª¸ê³¼ ë§ˆìŒì„ ížë§í•˜ì„¸ìš”" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-8 items-center bg-dark-800 rounded-3xl p-8 border border-white/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full md:w-1/2 h-64 md:h-96 rounded-2xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full md:w-1/2 space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-gold-500", children: "í”„ë¦¬ë¯¸ì—„ ì¶œìž¥ ë§ˆì‚¬ì§€" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-300 leading-relaxed", children: [
              "ì„¸ë¶€ ì „ ì§€ì—­ 30ë¶„ ì´ë‚´ ë°©ë¬¸ ê°€ëŠ¥í•©ë‹ˆë‹¤. ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "ì—„ê²©í•œ êµìœ¡ì„ ì´ìˆ˜í•œ ì „ë¬¸ í…Œë¼í”¼ìŠ¤íŠ¸ê°€ ê³ ê°ë‹˜ì´ ê³„ì‹  ê³³ìœ¼ë¡œ ì°¾ì•„ê°‘ë‹ˆë‹¤. ìµœê³ ê¸‰ ì˜¤ì¼ê³¼ ì „ë¬¸ì ì¸ ê¸°ìˆ ë¡œ ì—¬í–‰ì˜ í”¼ë¡œë¥¼ ë§ë”ížˆ ì”»ì–´ë“œë¦½ë‹ˆë‹¤."
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-gray-400", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 text-gold-500 mr-2" }),
                " ì „ì› 20ëŒ€ ì—¬ì„± í…Œë¼í”¼ìŠ¤íŠ¸"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 text-gold-500 mr-2" }),
                " ìµœê³ ê¸‰ ì•„ë¡œë§ˆ ì˜¤ì¼ ì‚¬ìš©"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 text-gold-500 mr-2" }),
                " í•œêµ­ì¸ ë§¤ë‹ˆì € ì‹¤ì‹œê°„ ì¼€ì–´"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-gold-600 hover:bg-gold-700 text-white px-8 py-3 rounded-full font-bold transition-colors", children: "ë§ˆì‚¬ì§€ ì½”ìŠ¤ ë³´ê¸°" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "ì—ì½”ê±¸", className: "py-20 bg-dark-800/50 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: "ESCOT GIRL", subtitle: "ì—¬í–‰ì˜ íŠ¹ë³„í•œ íŒŒíŠ¸ë„ˆ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8", children: MANAGERS.map((manager) => /* @__PURE__ */ jsxRuntimeExports.jsx(ManagerCard, { manager }, manager.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center mt-10 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "border border-gold-500 text-gold-500 hover:bg-gold-500 hover:text-white px-8 py-2 rounded-full transition-colors text-sm font-bold", children: "í”„ë¡œí•„ ë”ë³´ê¸°" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2 text-gray-400 text-sm bg-dark-900/50 px-4 py-2 rounded-full border border-white/5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 bg-green-500 rounded-full animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "ì‹ ê·œ ë§¤ë‹ˆì € ì˜ìž… ì•Œë¦¼ ë°›ê¸°" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "relative inline-flex items-center cursor-pointer ml-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", className: "sr-only peer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-5 bg-gray-700 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-gold-500 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-gold-600" })
            ] })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "í’€ë¹Œë¼", className: "py-20 px-4 max-w-7xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionTitle, { title: "LUXURY POOL VILLA", subtitle: "í”„ë¼ì´ë¹—í•œ ê³µê°„ì—ì„œì˜ íŒŒí‹°" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative rounded-2xl overflow-hidden aspect-[4/3] cursor-pointer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: `https://images.unsplash.com/photo-1580587771525-78b9dba3b91d?auto=format&fit=crop&q=80&w=800&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=${800 + i}`,
              alt: `Pool Villa ${i}`,
              className: "w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-90" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-xl font-bold text-white mb-1", children: [
              "ì‹œì› í’€ë¹Œë¼ ",
              i,
              "í˜¸ì "
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 text-sm", children: "ë°© 4ê°œ / í™”ìž¥ì‹¤ 4ê°œ / ì „ìš© ìˆ˜ì˜ìž¥" })
          ] })
        ] }, i)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-dark-800/30 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BoardList, { title: "ê³µì§€ì‚¬í•­", posts: notices, boardId: "notice" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BoardList, { title: "ì´ìš©í›„ê¸°", posts: reviews, boardId: "free" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 bg-gradient-to-r from-gold-600 to-gold-500 text-center px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-bold text-white mb-4", children: "ì§€ê¸ˆ ë°”ë¡œ ì˜ˆì•½í•˜ì„¸ìš”!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 mb-8", children: "24ì‹œê°„ í•œêµ­ì¸ ë§¤ë‹ˆì €ê°€ ì¹œì ˆí•˜ê²Œ ìƒë‹´í•´ë“œë¦½ë‹ˆë‹¤." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              onClick: () => {
              ...
              className: "bg-[#FEE500] text-[#3c1e1e] px-8 py-3 rounded-full font-bold shadow-lg hover:bg-[#e6cf00] transition-colors flex items-center justify-center",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-5 h-5 mr-2 fill-current" }),
                " ì¹´ì¹´ì˜¤í†¡: siwon9"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              onClick: () => window.open("https://t.me/siwoncare", "_blank"),
              className: "bg-[#229ED9] text-white px-8 py-3 rounded-full font-bold shadow-lg hover:bg-[#1e8bc0] transition-colors flex items-center justify-center",
              children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              onClick: () => window.open("https://line.me/ti/p/~siwoncare", "_blank"),
              className: "bg-[#06C755] text-white px-8 py-3 rounded-full font-bold shadow-lg hover:bg-[#05a546] transition-colors flex items-center justify-center",
              children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-dark-900 border-t border-white/10 py-12 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto text-center text-gray-500 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2", children: "Â© 2024 SIWON TOUR. All rights reserved." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "ì„¸ë¶€ ì‹œì›íˆ¬ì–´ | ëŒ€í‘œ: ê¹€ì‹œì› | ì‚¬ì—…ìžë“±ë¡ë²ˆí˜¸: 000-00-00000" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-xs", children: "ë³¸ ì‚¬ì´íŠ¸ëŠ” í¬íŠ¸í´ë¦¬ì˜¤ ëª©ì ìœ¼ë¡œ ì œìž‘ëœ ë°ëª¨ ì‚¬ì´íŠ¸ìž…ë‹ˆë‹¤. ì‹¤ì œ ìš´ì˜ë˜ëŠ” ì‚¬ì´íŠ¸ê°€ ì•„ë‹™ë‹ˆë‹¤." })
    ] }) }),
